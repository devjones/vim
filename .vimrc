...
"doing this to save crontab files
set backupcopy=yes
...
" have vim use the system clipboard
...
" Open NerdTree Plugin <F2>
nnoremap <silent> <F2> :NERDTree<CR>

" Open the TagList Plugin <F3>
nnoremap <silent> <F3> :Tlist<CR>

" Open the Project Plugin <F4>
nnoremap <silent> <F4> :Project<CR>
...
" Omnicompletion a.k.a. IntelliSense
filetype plugin on
